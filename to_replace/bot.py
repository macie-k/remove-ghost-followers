...
from .bot_block import block, block_bots, block_users, unblock, unblock_users, remove_follower, check_if_replaced
...
class Bot(object):
    ...
    def remove_follower(self, user_id):
        return remove_follower(self, user_id)

    def check_if_replaced(self):
        check_if_replaced(self)
